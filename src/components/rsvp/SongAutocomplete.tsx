...
export const SongAutocomplete = ({ code, setSongs }: SongAutocompleteProps) => {
    ...
    const handleInputFocus = () => !isOpen && setIsOpen(true)

    return (
        <div>
            <Label className="pt-3 block text-wedding-darkgray text-lg max-w-lg mx-auto">{t("Songs")}</Label>
                    ...
                    <Popover.Trigger asChild>
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder={selectedItems.length > 0 ? "Add more songs..." : t("search_song")}
                    ...
                    <Popover.Portal>
                        ...
                        >
                            ...
                            {!loading && songs.length === 0 && searchTerm.trim() === '' && isOpen && (
                                <div className="p-3 text-sm text-gray-500">Type to see suggestions.</div>
                            )}
                        </Popover.Content>
                    </Popover.Portal>
                </Popover.Root>
