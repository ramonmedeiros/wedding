    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 pb-20 max-w-2xl">
        <div className="flex flex-col items-center space-y-8 fade-in-delay-2">
          ...
          {/* Pix Key Display with Copy Button */}
          <div className="w-full space-y-4">
            <label className="block text-sm font-medium text-wedding-darkgray text-center">
              {t("presente.pix_key")}
            </label>
            <div className="flex items-center gap-2 bg-white border border-wedding-gray/30 rounded-md p-4 shadow-sm">
              <input
                type="text"
                value={PIX_KEY}
                readOnly
                className="flex-1 text-center text-lg font-mono text-wedding-darkgray bg-transparent border-none outline-none"
              />
              <Button
