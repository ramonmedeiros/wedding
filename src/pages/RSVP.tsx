...
import { SongAutocomplete } from "./../components/rsvp/SongAutocomplete";
  ...
  const handleSubmit = (e) => {
    ...
    updateFamily(
      ...
      alergies.filter(a => a.count > 0)
        ...
        setIsSubmitted(confirmation)
      })
  };

  return (
    <Layout>
      <Title title={t("rsvp")} description={isSubmitted === undefined && t("please_rsvp")} />
        ...
        {isSubmitted !== undefined &&
          <div className="text-center py-16">
            ...
            <p className="mt-4 max-w-md mx-auto text-wedding-gray">
              {isSubmitted && t("rsvp_submitted") || t("rsvp_negative_submitted")}
            </p>
          </div>
        }
        {code === null && <CodeInput />}
